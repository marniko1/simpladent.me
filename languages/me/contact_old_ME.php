            ...
            <div class="section main_section" id="contactsSection_1">
                <div class="main_block">
                    ...
                    <div class="article">
                        ...
                        <p>+382 69 615 399</p> 
                        <h2>Email:</h2>
                        <p><a href="mailto:info@simpladent.hr">info@simpladent.me</a></p>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="section" id="contactsSection_2">
                ...
                <div id="mapBlock">
					...
					<div class="contactworldmap" style="">
						<p style="width:464px; float:right;">Sve klinike pogledajte na : <a href="http://simpladent-implant.solutions/?page=map&i=5" target="_blank">world map</a></p>
					</div>				
					<br />						
					<br />
