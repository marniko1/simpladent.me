            ...
            <div class="section" id="contactsSection_2">
                ...
                <div class="contactsMapBlock">
                        ...
                        <div id="cities_list">
                            ...
                            <ul>
										<!--<a href="/?page=clinic&c="osa_simpladent"&i=10">-->
											<li data-clinic="osa_simpladent" data-id="4" data-coords="47.400000, 27.0033098">Budva Region</li>											
										<!--</a>-->
                             </ul>
                        </div>
					...
					<div class="contactworldmap" style="">
						<p style="width:100%; float:right;">Sehen Sie alle Kliniken auf der <a href="http://simpladent-implant.solutions/?page=map&i=5" target="_blank">Weltkarte</a></p>
					</div>				
					<br />						
					<br />				
